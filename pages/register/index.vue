  ...
  <div class="container">
    <div class="agile">
      <div class="signin-form profile">
        <img class="centar" src="@/static/images/registerpic.png">
        ...
        <div class="login-form">
          <form action="#" method="post" @submit.prevent="register">
            ...
            <input type="text" v-model="company" name="company" placeholder="Company" required>
            ...
            <input type="text" v-model="website" name="website" placeholder="Website" required>
